...
Start with `prplmesh-0901-thin.tar` and its adjacent checksum in an empty
directory:
...
```sh
lxc console prplmesh-20-0901 --show-log
...
lxc config set prplmesh-20-0901 boot.autostart false  # optional
```
...
PRPLMESH_THIN_CONFIRM=READY-VM \
  deploy/lxd-vm/package-thin.sh release/0901
PRPLMESH_RELEASE_ID=0901 \
  deploy/lxd-vm/package-release.sh release/0901/prplmesh-0901-thin
```
