...
class RunnerTests(unittest.TestCase):
    ...
    def test_success_restores_and_reports_passed(self):
        ...
        contract = json.loads((run_dir / "rf-capabilities.json").read_text())
        self.assertEqual(contract["profile"], "signal-only-unqualified-airtime")
        self.assertEqual(contract["capabilities"]["channel_utilization"]["state"], "unsupported")
